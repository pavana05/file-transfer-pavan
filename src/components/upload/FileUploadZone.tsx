...
export const FileUploadZone: React.FC<FileUploadZoneProps> = ({
  ...
  return <div className={cn("w-full", className)}>
      <div {...getRootProps()} className={cn("relative border-2 border-dashed rounded-3xl p-12 sm:p-16 text-center transition-all duration-500 ease-out", "bg-card/95 backdrop-blur-xl", "border-border/40 hover:border-primary/50 shadow-card hover:shadow-hover", "group overflow-hidden", !disabled && "cursor-pointer hover:scale-[1.01] active:scale-[0.99]", isDragActive && !isDragReject && "border-primary/70 bg-primary/5 scale-[1.02] shadow-glow", isDragReject && "border-destructive/60 bg-destructive/5", disabled && "opacity-50 cursor-not-allowed")}>
