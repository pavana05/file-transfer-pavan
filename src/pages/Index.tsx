...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-mesh relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-accent/2 rounded-full blur-[80px] animate-float" style={{
      animationDelay: '1s'
    }}></div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="fixed top-6 right-6 z-50 flex items-center gap-3 animate-fade-in">
          {user ? <div className="flex items-center gap-3 bg-card/95 backdrop-blur-md border border-border/60 rounded-xl px-4 py-2.5 shadow-glass transition-all duration-300">
            ...
            </div> : <Button variant="outline" size="sm" onClick={() => window.location.href = '/auth'} className="bg-card/95 backdrop-blur-md border border-border/60 hover:bg-primary/10 hover:border-primary/50 px-6 py-2.5 h-auto rounded-xl shadow-glass transition-all duration-300">
              Sign In
            </Button>}
          <ThemeToggle />
        </div>
        ...
        <div className="text-center mb-16 md:mb-20 animate-fade-in max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mb-8">
            <div className="relative">
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-3xl bg-gradient-primary flex items-center justify-center shadow-md">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            <Badge variant="secondary" className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-card/60 backdrop-blur-md border border-border/60 hover:border-primary/50 transition-all duration-300 text-sm font-medium">
          ...
          <div className="max-w-md mx-auto">
            <Card className="p-6 bg-card/40 backdrop-blur-md border border-border/60 rounded-2xl shadow-sm transition-all duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16 md:mb-20 max-w-6xl mx-auto">
          <Card className="group p-8 text-center bg-card/40 backdrop-blur-md border border-border/60 hover:border-primary/50 rounded-3xl shadow-sm transition-all duration-500 hover:-translate-y-2">
            <div className="relative mb-6 mx-auto w-20 h-20">
              <div className="relative w-full h-full rounded-2xl bg-gradient-primary flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-500">
          ...
          <Card className="group p-8 text-center bg-card/40 backdrop-blur-md border border-border/60 hover:border-primary/50 rounded-3xl shadow-sm transition-all duration-500 hover:-translate-y-2">
            <div className="relative mb-6 mx-auto w-20 h-20">
              <div className="relative w-full h-full rounded-2xl bg-gradient-secondary flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-500">
          ...
          <Card className="group p-8 text-center bg-card/40 backdrop-blur-md border border-border/60 hover:border-primary/50 rounded-3xl shadow-sm transition-all duration-500 hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
            <div className="relative mb-6 mx-auto w-20 h-20">
              <div className="relative w-full h-full rounded-2xl bg-gradient-primary flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-500">
        ...
        <Card className="mt-16 md:mt-20 p-8 md:p-10 lg:p-12 bg-card/40 backdrop-blur-md border border-border/60 rounded-3xl shadow-sm max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-secondary flex items-center justify-center flex-shrink-0 shadow-md">
