-- Allow UPDATEs by marking functions VOLATILE instead of STABLE

-- 1) get_file_by_token -> VOLATILE
...
BEGIN
  ...
  -- Update last accessed timestamp (qualified)
...
-- 3) get_collection_by_token -> VOLATILE
